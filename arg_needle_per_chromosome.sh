...
arg_needle --hap_gz /mnt/project/data/hap/ALL.chr${1}.phase3_shapeit2_mvncall_integrated_v5b.20130502.genotypes.dedup_snps.haps \
--map /mnt/project/data/hap/ALL.chr${1}.phase3_shapeit2_mvncall_integrated_v5b.20130502.genotypes.dedup_snps.map \
--out chr${1} \
--mode sequence \
--chromosome ${1}
