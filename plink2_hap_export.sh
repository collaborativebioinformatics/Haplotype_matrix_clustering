...
paste <(cut -f2 ALL.${1}.phase3_shapeit2_mvncall_integrated_v5b.20130502.genotypes.snps.sample.old -d' '| sed 's/ID_2/ID_1/g') <(cut -f2-4 ALL.${1}.phase3_shapeit2_mvncall_integrated_v5b.20130502.genotypes.snps.sample.old
 -d ' ') -d ' ' > ALL.${1}.phase3_shapeit2_mvncall_integrated_v5b.20130502.genotypes.snps.sample
# push back to /data/hap
